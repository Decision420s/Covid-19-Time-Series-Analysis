...
```{r final-pred, echo = FALSE, results = 'hide', fig.cap = 'Forecasts of Covid new cases in next 10 days', fig.align = 'center', fig.pos = 'H', out.width = '90%', fig.height = 4, fig.width = 8}
