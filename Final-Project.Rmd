...
```{r signal-2, echo=FALSE, results='hide', fig.cap='Differencing model and periodogram.',  fig.align = 'center', fig.pos="H", fig.height=3, out.width="80%"}
layout(matrix(c(1,2),ncol=2))
